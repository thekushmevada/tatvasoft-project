...
// const request = axios.create({  baseURL: "https://web1.anasource.com/BookStore/api/BookStore/" , 
// // url = base url + request url 
// // baseURL: "http://localhost:5000/", baseURL: "https://book-e-sell-node-api.vercel.app/", 
// // baseURL: "https://helperland1.azurewebsites.net/", 
// // baseURL: "https://helperland1.azurewebsites.net/", 
// // baseURL: "http://192.168.1.20/", timeout: 12400000, responseType: "json", }); 
// // https://book-edsad-sell-node-api.vercel.app/api/user/roles let requests = []; let conflictRequest = ""; 
...
// // remove completed request function 
// removeRequest(req) { const i = requests.indexOf(req); 
